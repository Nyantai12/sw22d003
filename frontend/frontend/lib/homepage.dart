    ...
    return Stack(
      children: [
        ...
        child: GNav(
          ...
          tabs: const [
            GButton(icon: Icons.home, text: 'Нүүр'),
            GButton(icon: Icons.safety_divider, text: 'Үйлчилгээ'),
            GButton(icon: Icons.history, text: 'Түүх'),
            GButton(icon: Icons.school, text: 'Сургалт'),
          ],
        ),
        ),
    ...
    Padding(
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => UilchilgeePage()),
          );
        },
        child: Text(
          'Бүгд',
