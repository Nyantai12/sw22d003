...
class ADSalonDetPage1 extends StatefulWidget {
  final String salonid;

  const ADSalonDetPage1({
    Key? key,
    required this.salonid,
  }) : super(key: key);

  @override
  State<ADSalonDetPage1> createState() => _ADSalonDetPageState();
}

class _ADSalonDetPageState extends State<ADSalonDetPage1> {
